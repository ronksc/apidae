					...
					<div class="col-12 banner-container">
						...
						<div class="text-wrapper">
							<div class="text-container">
								<h1>OUR STORY</h1>
								<p>They say your baby’s entire childhood could be summed up in 940 saturdays – and 260 of them are gone by the time your child turns five. </p>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="col-lg-10 offset-lg-1 padding-30">
						<div class="row h-100">
							<div class="col-12 col-lg-6 text-wrapper">
								<div class="text-container">
									<div class="normal-text">
										<p>There is no “best” or one-size-fits-all product out there, only ones that can be considered most suitable for each unique lifestyle and environment. We love bringing quality to kids, because it matters. Buying better, also means buying less – leaving minimal impact on the environment so that our kids can make the most of their future world. 
			</p>
									</div>
									<div class="quote-text">
							...
							<div class="col-12 col-lg-6 img-container right">
								<img src="<?=get_stylesheet_directory_uri()?>/assets/images/our-story/our-story-4.png" class="img-fluid" />
							</div>
						</div>
					</div>
				</div>
